...
TEST_CASE("linked_list")
{
    	//exercise 2
    	int sum;
      node *ns = NULL; //changed all sentinel to NULL
    	ns = make_node (1,
			make_node (2,
				   make_node (3,
					      make_node (4,
...
TEST_CASE("btree")
{
  ...
  REQUIRE (Full (root) == 0); //changed from 1 to 0, since it can never be full
